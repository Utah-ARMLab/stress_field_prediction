...
if __name__ == "__main__":
    ...
    dataset_path = "/home/baothach/shape_servo_data/stress_field_prediction/mgn_dataset/processed_data"
    dataset = StressPredictionDataset(dataset_path)
    dataset_size = len(os.listdir(dataset_path))
    batch_size = 256
    
    train_len = int(3e5)    #round(dataset_size*0.9)
    test_len = 3000     #round(dataset_size*0.1)-1
